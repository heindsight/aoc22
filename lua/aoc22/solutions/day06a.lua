-- Find the position of the first start-of-packet marker (sequence of 4 unique characters) in a datastream
...
function P.solve(in_buffer)
    ...
    local packet_start = day06.find_marker(datastream, 4)
